  ...
  processMessage (header, data, socket) {
    switch (header.packet.command) {
      ...
      case MrimMessageCommands.LOGIN2: {
        ...
        const dataToSend2 = new BinaryConstructor().integer(0, 4).finish()
        ...
        this.logger.debug('Через MRIM_CS_CONTACT_LIST2 наврём, что у нас 2 группы и 2 контакта')
        
        const dataToSend3 = Buffer.from("", 'hex');
