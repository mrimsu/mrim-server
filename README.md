...
- Visual Studio 2022 Build Tools(для Windows)
...
Если при запуске выходит ошибка `Could not load the "sharp" module using the linux runtime`, введите в консоли `npm install sharp`
